...
wb_macro = pd.ExcelFile(prepare_report_path)
ws_macro = pd.read_excel(prepare_report_path, sheet_name='Path')
ws_macro.at[0, 'Path'] = report_path
ws_macro.to_excel(prepare_report_path, index=False, engine='openpyxl')
